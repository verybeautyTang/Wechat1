<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleShowSupport">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-if="showShop">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-if="showSupport">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="supportsClass[support.type]"  v-for="(support, index) in info.supports" :key="index">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="toggleShowSupport">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
